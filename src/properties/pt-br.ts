const ptBr = {
  locale: 'pt-BR',
  navigation: [
    { id: 'about', primary: 'Sobre o Chá', secondary: 'About the Shower' },
  ...
  hero: {
    ...
    body: 'Estamos muito felizes e mal podemos esperar para celebrar a chegada do nosso menino com as pessoas que amamos!',
    bodySecondary: 'We are so excited and can’t wait to celebrate the arrival of our little boy with the people we love!',
    photo: 'FOTO DA GRAVIDEZ AQUI',
    photoHint: '(FUTURA SESSÃO HORIZONTAL)',
    cta: 'CONFIRMAR PRESENÇA / RSVP',
  },
  dates: {
    title: 'Duas celebrações para um bebê muito amado',
  ...
  games: {
    ...
    items: [
      { icon: 'onesie', title: 'Decore um Body', text: 'Decore um body para o bebê usar.' },
      { icon: 'letter', title: 'Desejos para o Bebê', text: 'Escreva um conselho ou mensagem para o futuro.' },
  ...
  gallery: {
    title: 'Um pedacinho do nosso bebê',
    photos: ['3D ULTRASSOM\n(FUTURA FOTO)', 'ROSTINHO\n(FUTURA FOTO)', 'PEZINHOS\n(FUTURA FOTO)'],
    announcement: 'É UM MENINO!!!',
  },
  gifts: {
    title: 'Presentes',
    lead: 'A sua presença já é um presente para nós.',
    body: 'Para quem perguntou como pode nos ajudar na preparação para a chegada do bebê, deixamos algumas opções abaixo.',
    registryTitle: 'Lista da Amazon',
    registryText: 'Veja nossa lista com algumas das coisas que vamos precisar.',
